...
\midcolumn{\lstinputlisting[language=pdl]{pdl/puyopuyo/Block.txt}\lstinputlisting[language=pdl]{pdl/puyopuyo/BlockFall.txt}}{\includegraphics[width=\textwidth]{presentationfiles/Block-BlockFall-pp.jpg}}
\end{frame}
...
\lstinputlisting[language=pdl,lastline=11]{pdl/puyopuyo/AttribuerGroupe.txt}

\end{frame}

\begin{frame}
\lstinputlisting[language=pdl, firstline=12]{pdl/puyopuyo/AttribuerGroupe.txt}
\end{frame}
